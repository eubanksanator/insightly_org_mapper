...
class OrganisationsControllerTest < ActionController::TestCase
  ...
  test "should create organisation" do
    assert_difference('Organisation.count') do
      post :create, organisation: { address: @organisation.address, city: @organisation.city, latitude: @organisation.latitude, longitude: @organisation.longitude, state: @organisation.state }
    end
  ...
  test "should update organisation" do
    patch :update, id: @organisation, organisation: { address: @organisation.address, city: @organisation.city, latitude: @organisation.latitude, longitude: @organisation.longitude, state: @organisation.state }
    assert_redirected_to organisation_path(assigns(:organisation))
  end
